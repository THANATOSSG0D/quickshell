  ...
  Variants {
    ...
    delegate: Component {
      PanelWindow {
        ...
        WlrLayershell.namespace: "disk-widget"
        ...
        Item {
          ...
          width: diskContent.implicitWidth
          height: diskContent.implicitHeight
          ...
          MouseArea {
            ...
            onClicked: (mouse) => {
              if (mouse.button === Qt.RightButton)
                diskWidget.position = (diskWidget.position + 8) % 9
              else
                diskWidget.position = (diskWidget.position + 1) % 9
            }
          }

          DiskContent { id: diskContent; grouped: false }
        }
      }
    }
  }
