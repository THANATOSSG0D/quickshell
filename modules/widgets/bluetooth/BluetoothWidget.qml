  ...
  Variants {
    ...
    delegate: Component {
      PanelWindow {
        ...
        WlrLayershell.namespace: "bluetooth-widget"
        ...
        Item {
          ...
          width: bluetoothContent.implicitWidth
          ...
          MouseArea {
            ...
            onClicked: (mouse) => {
              if (mouse.button === Qt.RightButton)
                bluetoothWidget.position = (bluetoothWidget.position + 8) % 9
              else
                bluetoothWidget.position = (bluetoothWidget.position + 1) % 9
            }
          }

          BluetoothContent { id: bluetoothContent; grouped: false }
        }
      }
    }
  }
