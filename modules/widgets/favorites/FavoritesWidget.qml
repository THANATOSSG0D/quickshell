...
Scope {
  ...
  Variants {
    model: (layoutCfg.isGrouped("favorites") || !layoutCfg.isEnabled("favorites")) ? [] : Quickshell.screens
    ...
    delegate: Component {
      PanelWindow {
        ...
        WlrLayershell.namespace: "favorites-widget"
        ...
        Item {
          ...
          width: favoritesContent.implicitWidth
          height: favoritesContent.implicitHeight

          MouseArea {
            anchors.fill: parent
            acceptedButtons: Qt.RightButton
            onClicked: (mouse) => {
              favoritesWidget.position = (favoritesWidget.position + 8) % 9
            }
          }

          FavoritesContent { id: favoritesContent; grouped: false }
        }
      }
    }
  }
