...
// ── ClockPanel ────────────────────────────────────────────────────────────
// PanelWindow para o relógio e timer/pomodoro.
// Usa layer-shell — funciona corretamente em qualquer layout de monitores,
// incluindo monitores com coordenadas globais negativas.
...
PanelWindow {
  ...
  // Expõe o ClockContent para Clock.qml injetar clockContent
  ...
  implicitWidth:  barIsHorizontal ? panelWidth : panelWidth
