  ...
  PopupWindow {
    ...
    Rectangle {
      ...
      Column {
        ...
        readonly property int contentRowWidth: Math.max(root._cfg(root._anchorItem, "MinWidth", TooltipSettings.minWidth) - TooltipSettings.contentPadding, titleRow.implicitWidth)
