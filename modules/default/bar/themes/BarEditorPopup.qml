...
PopupWindow {
  ...
  Rectangle {
    ...
    color:        Qt.rgba(popup.colorPanelBg.r, popup.colorPanelBg.g, popup.colorPanelBg.b, 0.97)
      ...
      ColumnLayout {
              ...
              Column {
                ...
                Flow {
                  ...
                  Repeater {
                    ...
                    // ── CHIP ──────────────────────────────────────────────
                    // chipOuter: posicionado pelo Flow, nao se move
                    // chipGhost: sem anchors, e o drag.target real
                    // chipMa:    MouseArea — drag.threshold=8 separa click de drag
                    //
                    // O botao X consome o evento (accepted=true) para
                    // que chipMa nao inicie drag ao clicar no X.
                    delegate: Item {
                      id: chipOuter
                      required property string modelData
                      ...
                      // chipMa fica ABAIXO do visual (z:-1) para que o botao X,
                      // declarado dentro do Rectangle visual, receba eventos antes.
                      // drag.target=chipGhost: o ghost se move, o visual fica parado.
                      MouseArea {
                        id: chipMa
                        anchors.fill: parent
                        z: -1
        ...
        Flow {
          ...
          Repeater {
            ...
            // Pool chip: mesmo padrao ghost/static
            delegate: Item {
              id: poolOuter
              required property var modelData
              ...
              MouseArea {
                ...
                onReleased: {
                  // So faz drop se foi drag real (drag.active implica threshold cruzado)
                  if (drag.active) poolGhost.Drag.drop()
                  poolGhost.x = 0; poolGhost.y = 0
                }
                // Click simples (drag.active==false no released) adiciona ao slot padrao
